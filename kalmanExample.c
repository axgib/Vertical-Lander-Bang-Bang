 ...
 * @date       3/14/2018
 * 
 * the KF estimates the next state through a probabilistic view informed by previous states
 * suggestions made by Alex 
 * 5/31/2024
 * 
 * KF state will be :
 * x1 = altitude
 * x2 = velocity
 * x3 = acceleration bias
 */
...
//Define the same variables for now -AG
#define Nx 3
#define Ny 1
#define Nu 1
#define SAMPLE_RATE     200     // hz
#define DT              (1.0/SAMPLE_RATE) //Keep this handy, might change later -AG
...
//Initialize these the same as the example -AG
